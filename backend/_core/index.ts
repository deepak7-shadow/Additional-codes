...
import { processRazorpayWebhook } from "../arenaHub.router";
import { sendUpcomingBookingReminder } from "../bookingReminder";
...
async function startServer() {
  ...
  app.post("/api/scheduled/booking-reminder", sendUpcomingBookingReminder);
